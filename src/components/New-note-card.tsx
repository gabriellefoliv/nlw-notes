...
export function NewNoteCard({onNoteCreated}:NewNoteCardProps) {
    ...
    function handleStartRecording() {
        ...
        speechRecognition.continuous = true // não para a gravação caso pare de falar
        speechRecognition.maxAlternatives = 1 // traz a alternativa que a API acha que falou
        speechRecognition.interimResults = true // traz os resultados conforme vai falando
    ...
    return (
        <Dialog.Root>
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className='fixed overflow-hidden md:left-1/2 inset-0 md:inset-auto md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] md:h-[60vh] w-full bg-slate-700 md:rounded-md flex flex-col outline-none'>
